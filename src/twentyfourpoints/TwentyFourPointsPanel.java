...
public class TwentyFourPointsPanel extends JFrame{
	  ...
	  public TwentyFourPointsPanel() {
		...
		this.card1 = new JLabel(new ImageIcon(num1+".PNG"));
	    this.card2 = new JLabel(new ImageIcon(num2+".PNG"));
	    this.card3 = new JLabel(new ImageIcon(num3+".PNG"));
	    this.card4 = new JLabel(new ImageIcon(num4+".PNG"));
